...
BEGIN_MESSAGE_MAP(Cdemo3Dlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_PROGRESS, &Cdemo3Dlg::OnBnClickedButtonProgress)
	ON_BN_CLICKED(IDC_BUTTON_IP, &Cdemo3Dlg::OnBnClickedButtonIp)
	ON_BN_CLICKED(IDC_BUTTON_FILE, &Cdemo3Dlg::OnBnClickedButtonFile)
	ON_BN_CLICKED(IDC_BUTTON_DLG, &Cdemo3Dlg::OnBnClickedButtonDlg)
	ON_BN_CLICKED(IDC_BUTTON_SEND, &Cdemo3Dlg::OnBnClickedButtonSend)
	ON_BN_CLICKED(IDC_BUTTON_SERV, &Cdemo3Dlg::OnBnClickedButtonServ)
END_MESSAGE_MAP()
...
BOOL Cdemo3Dlg::OnInitDialog()
{
	...
	pListCtrl->InsertColumn(0, _T("资源名称"), LVCFMT_CENTER, 150);
	pListCtrl->InsertColumn(1, _T("资源大小"), LVCFMT_CENTER, 80);
	pListCtrl->InsertColumn(1, _T("拥有者"), LVCFMT_CENTER, 80);
...
void Cdemo3Dlg::OnBnClickedButtonProgress()
{
...
void Cdemo3Dlg::OnBnClickedButtonIp()
{
	CIPAddressCtrl* pIP = (CIPAddressCtrl*)GetDlgItem(IDC_IPADDRESS1);
	BYTE n1, n2, n3, n4;
	CString str;
...
void Cdemo3Dlg::OnBnClickedButtonFile()
{
	CListCtrl* pListCtrl = (CListCtrl*)GetDlgItem(IDC_LIST1);

	pListCtrl->InsertItem(0, _T("勇敢的心.mp4"));
	pListCtrl->SetItemText(0,1, _T("30G"));
	pListCtrl->SetItemText(0, 2, _T("卫青"));

}


void Cdemo3Dlg::OnBnClickedButtonDlg()
{
...
void Cdemo3Dlg::OnBnClickedButtonServ()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	while (true)
	{
		...
		SetDlgItemText(IDC_STATIC_INFO, CString(buff));
	}
	
}


void Cdemo3Dlg::OnBnClickedButtonSend()
{
	// TODO: 在此添加控件通知处理程序代码
